...
// Find the closing of activeTab === 'billing'
// It ends right before `          </div>\n        </main>`
const endTagStr = "          </div>\n        </main>";
let endIndex = content.indexOf(endTagStr, startIndex);
...
// Rewind back to the closing brace/paren of the billing tab
const closingStr = "            )}\n";
endIndex = content.lastIndexOf(closingStr, endIndex);
endIndex += closingStr.length;
